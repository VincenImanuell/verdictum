...
export default function InspectorPanel() {
  ...
  async function tick() {
    ...
    const prevS = s;
    setSteps("Recalibrating… confirm, then await consensus");
    try {
  ...
  return (
    <section className="section card">
      <div>
        <h2 style={{ margin: 0 }}>The Inspector — autonomy</h2>
      ...
      <div className="gaugewrap" style={{ marginTop: 14 }}>
        ...
        <div>
          ...
          <div className="zone">
            <span>lenient · balanced · severe</span> ·{" "}
            <span className="mono">
              {Number(tickCount ?? 0n)}× recalibrated
            </span>
          </div>
